...
ggplot() +
  geom_point(data=caro60, aes(E, N), color='blue') +
  geom_point(data=caro_3, aes(E, N), color='green') +
  geom_path(data=caro60, aes(E, N), color='blue') +
  geom_path(data=caro_3, aes(E, N), color='green')

#comparing 1 minute and 6 minute Datapoints
ggplot() +
  geom_point(data=caro60, aes(E, N), color='blue') +
  geom_point(data=caro_6, aes(E, N), color='green') +
  geom_path(data=caro60, aes(E, N), color='blue') +
  geom_path(data=caro_6, aes(E, N), color='green')

#comparing 1 minute and 9 minute Datapoints
ggplot() +
  geom_point(data=caro60, aes(E, N), color='blue') +
  geom_point(data=caro_9, aes(E, N), color='green') +
  geom_path(data=caro60, aes(E, N), color='blue') +
  geom_path(data=caro_9, aes(E, N), color='green')

#compating speed and time over all Datasets
ggplot() +
  geom_line(data=caro60, aes(DatetimeUTC, speed)) +
  geom_line(data=caro_9, aes(DatetimeUTC, speed)) +
  geom_line(data=caro_6, aes(DatetimeUTC, speed)) +
  geom_line(data=caro_3, aes(DatetimeUTC, speed)) +
